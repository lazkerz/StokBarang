...
public class kategoriperbrng_user extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kategoriperbrng_user);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent pindah = new Intent(kategoriperbrng_user.this, dashboard_user.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent pindah = new Intent(kategoriperbrng_user.this, kategori_user.class);
                startActivity(pindah);
            }
        });
