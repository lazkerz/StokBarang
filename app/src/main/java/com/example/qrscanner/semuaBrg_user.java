...
public class semuaBrg_user extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_semua_brg_user);
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent pindah = new Intent(semuaBrg_user.this, dashboard_user.class);
